        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.chickens.update', $chicken) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name', $chicken->name)" required autofocus />
                        ...
                        <div>
                            ...
                            <x-text-input id="breed" name="breed" type="text" class="mt-1 block w-full" :value="old('breed', $chicken->breed)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="acquired_at" name="acquired_at" type="date" class="mt-1 block w-full" :value="old('acquired_at', $chicken->acquired_at->toDateString())" required />
                        ...
                        <div>
                            ...
                            <select id="caretaker_id" name="caretaker_id" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                ...
                                @foreach ($caretakers as $caretaker)
                                    <option value="{{ $caretaker->id }}" {{ old('caretaker_id', $chicken->caretaker_id) == $caretaker->id ? 'selected' : '' }}>
